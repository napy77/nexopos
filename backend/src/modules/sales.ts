...
salesRouter.get("/:id/ticket.pdf", async (req, res, next) => {
  try {
    ...
    doc.fontSize(8).font("Helvetica").text("Ticket no fiscal", { align: "center" });
    doc.moveDown(0.5);
    ...
    const methods: Record<string, string> = { cash: "Efectivo", card: "Tarjeta", account: "Cuenta corriente" };
